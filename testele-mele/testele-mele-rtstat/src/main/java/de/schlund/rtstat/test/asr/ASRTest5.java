...
public class ASRTest5 extends TestCase {
    ...
    public void testTestdata05() throws Exception {
        System.out.println(getClass().getName());
        String testfile = "testdata/testdata05.txt";
        String calleePrefix = "49721";

        ASR asr = setup(testfile, new String[] { calleePrefix });
        
       /* ASRCallData cd = asr.getASRTree().getTreeNode(Constants.PROVIDER_EUTEX).getASRCallData(calleePrefix);
        assertEquals(1, cd.getAllCalls());
